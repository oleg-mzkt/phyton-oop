# Задача:
# Ппрограмма должна вести учёт и движение оборудования от постановки на учёт и до передачи на склад и конкретному
# пользователю за которым будет закрпелено, до тех пор поко он его не сдаст и оно не будет списано. Программа должна
# учитывать найменование оборудования, модель, учётный и серийный номера оборудования, место подключения или хранения,
# а также за кем числится(ФИО и ID)
